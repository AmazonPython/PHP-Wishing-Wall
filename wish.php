			...
			<div class="c-content">
				...
				<div class="papercontent">
					<div class="left">
						...
						<div class="left-bottom">
							<textarea cols="25" rows="8" id="textfont" name="textfont" required></textarea><!--愿望内容，必填项-->
						</div>
					</div>
					<div class="right">
						<div class="right-top">
				...
				<div class="name">
					...
					<div class="name-right">
						<input id="nameright" type="text" name="nameright" value="" required><!--署名，必填项-->
					</div>
				</div>
				<div class="code">
					<div class="code-left">
                ...
                <!--点击此处许下愿望-->
				<input style="BORDER-RIGHT: #f33b78 1px outset; BORDER-TOP: #f33b78 1px outset; FONT-WEIGHT: bold;
				 BORDER-LEFT: #f33b78 1px outset;COLOR: #ffffff; BORDER-BOTTOM: #f33b78 1px outset;
				 BACKGROUND-COLOR: #70ae0b;margin-left: 225px" type="submit" value="→ 开始贴许愿小纸条 ←" name="submit">
